document.addEventListener('DOMContentLoaded', () => {
    ...
    async function loadUserDataFromServer() {
        ...
        try {
            ...
            // UWAGA: Pole "Informacje dodatkowe" nie jest obecnie zapisywane w bazie danych.
            // Wymaga to modyfikacji backendu (modelu ProductList i trasy zapisu).
        ...
        try {
            ...
            await fetch('/api/data/productlist', {
                ...
                body: JSON.stringify({
                    ...
                    items: scannedItems
                    // UWAGA: Informacje dodatkowe nie są tu wysyłane.
                })
            });
